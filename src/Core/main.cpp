...
// Clock Configuration
// =============================================================================
void configureSystemClock170MHz()
{
  RCC->CR = 0;
  ...
  RCC->CFGR = RCC_CFGR_HPRE_DIV1 | RCC_CFGR_PPRE1_DIV4 | RCC_CFGR_PPRE2_DIV1;

  FLASH->ACR = FLASH_ACR_LATENCY_3WS | FLASH_ACR_ICEN | FLASH_ACR_DCEN | FLASH_ACR_ICRST;
